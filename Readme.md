...
| `addStateTransitionStrategy(Strategy)` | Custom transition strategy                 |
| `addBottomSheetCallback(Callback)`     | External BottomSheet callback              |
| `addStateChangeObserver(Observer)`     | Add state change observer                  |
